			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _('Sélectionner les fichiers à ajouter') + '</div>' +
						'<div class="plupload_header_text">' + _('Ajouter les fichiers et cliquer sur Lancer.') + '</div>' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Placer les fichiers ici.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _('Ajouter') + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _('Lancer') + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_('Stopper') + '</a>&nbsp;' +
						'</div>' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('Ajouter'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d fichiers en attente'), up.total.queued));
		}
